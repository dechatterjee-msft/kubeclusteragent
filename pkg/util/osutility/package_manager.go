...
func (f *FakePackageManager) Uninstall(ctx context.Context, packageNames ...string) error {
	return nil
}
...
var _ PackageManager = &FakePackageManager{}

func NewFakePackage() *FakePackageManager {
	f := &FakePackageManager{}
	return f
}

func (f *FakePackageManager) CheckInstalled(ctx context.Context, packageName string) bool {
	logger := log.From(ctx)
	logger.Info("Check if package is installed", "packageName", packageName)
	return packageName != ""
}

func (f *FakePackageManager) Install(ctx context.Context, packageNames ...string) error {
	logger := log.From(ctx)
...
func (f *FakePackageManager) Update(ctx context.Context) error {
	logger := log.From(ctx)
...
func (f *FakePackageManager) AddKey(ctx context.Context, urlStr string) error {
	logger := log.From(ctx)
...
func (f *FakePackageManager) AddRepository(ctx context.Context, repository, filename string) error {
	logger := log.From(ctx)
...
func (f *FakePackageManager) RemoveRepository(ctx context.Context, repository, filename string) error {
	logger := log.From(ctx)
	logger.Info("Adding package repository", "repository", repository, "filename", filename)
...
type LivePackageManager struct {
	exec Exec
	fs   Filesystem
}

var _ PackageManager = &LivePackageManager{}

func NewLivePackageManager(execUtil Exec, fsUtil Filesystem) *LivePackageManager {
	f := &LivePackageManager{
		exec: execUtil,
		fs:   fsUtil,
	}
...
func NewFakePackageManager(execUtil Exec, fsUtil Filesystem) *FakePackageManager {
	f := &FakePackageManager{
		exec: execUtil,
		fs:   fsUtil,
	}
...
func (f *LivePackageManager) CheckInstalled(ctx context.Context, packageName string) bool {
	logger := log.From(ctx)
...
func (f *LivePackageManager) Install(ctx context.Context, packageNames ...string) error {
	logger := log.From(ctx)
...
func (f *LivePackageManager) Uninstall(ctx context.Context, packageNames ...string) error {
	logger := log.From(ctx)
...
func (f *LivePackageManager) Update(ctx context.Context) error {
	logger := log.From(ctx)
	logger.Info("Updating packages")
...
func (f *LivePackageManager) AddKey(ctx context.Context, urlStr string) error {
	logger := log.From(ctx)
...
func (f *LivePackageManager) AddRepository(ctx context.Context, repository, filename string) error {
	logger := log.From(ctx)
	logger.Info("Adding package repository", "repository", repository, "filename", filename)
...
func (f *LivePackageManager) RemoveRepository(ctx context.Context, repository, filename string) error {
	logger := log.From(ctx)
