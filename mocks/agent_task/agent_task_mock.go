...
// ReconcilerStart mocks base method.
func (m *MockService) ReconcilerStart(arg0 context.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReconcilerStart", arg0)
}

// ReconcilerStart indicates an expected call of ReconcilerStart.
func (mr *MockServiceMockRecorder) ReconcilerStart(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcilerStart", reflect.TypeOf((*MockService)(nil).ReconcilerStart), arg0)
}

// ReconcilerStatus mocks base method.
func (m *MockService) ReconcilerStatus(arg0 context.Context) (*v1alpha1.GetClusterStatusReconcilerResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcilerStatus", arg0)
	ret0, _ := ret[0].(*v1alpha1.GetClusterStatusReconcilerResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReconcilerStatus indicates an expected call of ReconcilerStatus.
func (mr *MockServiceMockRecorder) ReconcilerStatus(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcilerStatus", reflect.TypeOf((*MockService)(nil).ReconcilerStatus), arg0)
}

// ReconcilerStop mocks base method.
func (m *MockService) ReconcilerStop(arg0 context.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReconcilerStop", arg0)
}

// ReconcilerStop indicates an expected call of ReconcilerStop.
func (mr *MockServiceMockRecorder) ReconcilerStop(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReconcilerStop", reflect.TypeOf((*MockService)(nil).ReconcilerStop), arg0)
}
